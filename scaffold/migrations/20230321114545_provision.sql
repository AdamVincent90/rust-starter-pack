...
CREATE TABLE "public"."audit_logs" ("id" serial NOT NULL, "user_agent" character varying(255) NULL, "web_path" character varying(50) NULL, "host_address" character varying(30) NULL, "origin_ip_address" character varying(30) NULL, "request_uuid" uuid NULL, "status_code" integer NULL, "created_at" timestamp NOT NULL DEFAULT now(), PRIMARY KEY ("id"));
